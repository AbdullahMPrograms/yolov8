...
:: --------------------------------------------------------------
:: set RYZEN_AI_INSTALLATION_PATH=C:\dell\RyzenAI\1.4.0
:: Set to 1.4.1
set RYZEN_AI_INSTALLATION_PATH=C:\Program Files\RyzenAI\1.4.1
...
:: --------------------------------------------------------------
set OpenCV_DIR=C:\opencv\mybuild\build

set buildType=Release
set src=%cd%
set dst=%cd%\build
:: Set Shared_libs to ON
